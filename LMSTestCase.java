...
public class LMSTestCase {
	...
	public void testRemoveBookByID() {
		...
		Library library = new Library();
		Book book1 = new Book("Book1", "Author1", 1, true, "N/A", "N/A");
		Book book2 = new Book("Book2", "Author2", 2, true, "N/A", "N/A");
	...
	public void testBookCheckedBackIn() {
		...
		Library library = new Library();
		Book book1 = new Book("Book1", "Author1", 1, false, "N/A", "N/A");
		...
		library.BookCheckedBackIn("Book1");
